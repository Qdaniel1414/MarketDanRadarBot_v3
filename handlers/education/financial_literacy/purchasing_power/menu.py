...
from .intro import purchasing_power_intro
from .calculator import purchasing_power_calculator
from .example import purchasing_power_example


async def purchasing_power_menu(
    update: Update,
